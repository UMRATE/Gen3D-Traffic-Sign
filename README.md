...
- **Scripts**: 
  ...
  - **Screenshot**: *(Insert city scene image here; upload an image to the repository and link it, e.g., `![City Scene](assets/city_scene.png)`)*
...
- **Real-World Application**:
  ...
  - 3D point cloud: ![3D Point Cloud](3D point cloud.jpg)
